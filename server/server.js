...
const ANIMALS = {
  lion:    { id: 'lion',    layer: 'ground',      attackLayer: 'ground', hp: 20, atk: 20, spd: 3,  atkCooldown: 3.0,  range: 3,  cost: 5 },
  elephant:{ id: 'elephant',layer: 'ground',      attackLayer: 'both',   hp: 50, atk: 6,  spd: 2,  atkCooldown: 1.5,  range: 5,  cost: 7 },
  eagle:   { id: 'eagle',   layer: 'air',         attackLayer: 'both',   hp: 10, atk: 1,  spd: 7,  atkCooldown: 0.6,  range: 1,  cost: 2 },
  monkey:  { id: 'monkey',  layer: 'ground',      attackLayer: 'both',   hp: 13, atk: 2,  spd: 4,  atkCooldown: 0.75, range: 10, cost: 3, ranged: true },
  mole:    { id: 'mole',    layer: 'underground', attackLayer: 'ground', hp: 13, atk: 1,  spd: 10, atkCooldown: 0.6,  range: 1,  cost: 2 },
  bee:     { id: 'bee',     layer: 'air',         attackLayer: 'both',   hp: 5,  atk: 1,  spd: 10, atkCooldown: 0.3,  range: 4,  cost: 1, stinger: true },
  bunny:   { id: 'bunny',   layer: 'ground',      attackLayer: 'ground', hp: 13, atk: 2,  spd: 6,  atkCooldown: 0.6,  range: 1,  cost: 2 },
  cat:     { id: 'cat',     layer: 'ground',      attackLayer: 'ground', hp: 16, atk: 2,  spd: 5,  atkCooldown: 0.6,  range: 2,  cost: 3, evasion: 0.5 },
  chick:   { id: 'chick',   layer: 'ground',      attackLayer: 'ground', hp: 6,  atk: 0.1,spd: 8,  atkCooldown: 0.3,  range: 1,  cost: 1, groupSpawn: 4 },
  cow:     { id: 'cow',     layer: 'ground',      attackLayer: 'ground', hp: 20, atk: 1,  spd: 3,  atkCooldown: 1.5,  range: 1,  cost: 3 },
  crab:    { id: 'crab',    layer: 'ground',      attackLayer: 'ground', hp: 6,  atk: 1,  spd: 6,  atkCooldown: 0.375,range: 1,  cost: 1 },
  deer:    { id: 'deer',    layer: 'ground',      attackLayer: 'ground', hp: 18, atk: 2,  spd: 4,  atkCooldown: 0.6,  range: 1,  cost: 3 },
  dog:     { id: 'dog',     layer: 'ground',      attackLayer: 'ground', hp: 16, atk: 3,  spd: 5,  atkCooldown: 0.5,  range: 1,  cost: 3 },
  fox:     { id: 'fox',     layer: 'ground',      attackLayer: 'ground', hp: 16, atk: 2,  spd: 5,  atkCooldown: 0.5,  range: 1,  cost: 2 },
  giraffe: { id: 'giraffe', layer: 'ground',      attackLayer: 'both',   hp: 16, atk: 3,  spd: 5,  atkCooldown: 0.75, range: 3,  cost: 4 },
  hog:     { id: 'hog',     layer: 'ground',      attackLayer: 'ground', hp: 15, atk: 1,  spd: 9,  atkCooldown: 0.3,  range: 1,  cost: 4 },
  koala:   { id: 'koala',   layer: 'ground',      attackLayer: 'both',   hp: 15, atk: 5,  spd: 1,  atkCooldown: 3.0,  range: 3,  cost: 2, ranged: true },
  panda:   { id: 'panda',   layer: 'ground',      attackLayer: 'ground', hp: 23, atk: 3,  spd: 2,  atkCooldown: 1.5,  range: 1,  cost: 3 },
  penguin: { id: 'penguin', layer: 'ground',      attackLayer: 'ground', hp: 13, atk: 1,  spd: 1,  atkCooldown: 0.6,  range: 1,  cost: 1 },
  pig:     { id: 'pig',     layer: 'ground',      attackLayer: 'ground', hp: 20, atk: 2,  spd: 3,  atkCooldown: 1.0,  range: 1,  cost: 3 },
  polar:   { id: 'polar',   layer: 'ground',      attackLayer: 'ground', hp: 30, atk: 6,  spd: 3,  atkCooldown: 1.0,  range: 1,  cost: 5 },
  tiger:   { id: 'tiger',   layer: 'ground',      attackLayer: 'ground', hp: 25, atk: 10, spd: 4,  atkCooldown: 0.5,  range: 2,  cost: 6, leap: true, leapRange: 5 },
};
